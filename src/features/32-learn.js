...
var LEARN_QA = [
 ...
 {s:'小升初', q:'民办摇号没中，是不是就没学上了？', a:'不是。公民同招下，未摇中的由公办统筹安排；关键是提前把公办对口路径的材料（户籍 / 居住等）逐项核对到位，别把全部筹码押在摇号上。', by:'教育顾问 · 示范'},
 {s:'初升高', q:'住校还是走读，怎么决定？', a:'先算三笔账：单程通勤时间（超过 40 分钟要认真权衡）、孩子自理与作息习惯、家庭陪伴需求。可以先用一个月「试住期」再定；无论哪种，保持固定的沟通节奏。', by:'教育顾问 · 示范'},
 {s:'高考', q:'强基计划值得报吗？', a:'强基适合「基础学科意向明确 + 能接受本硕博衔接培养」的孩子；它锁定的是一条长线路径，不适合「先占坑再说」。建议对照孩子真实的学科兴趣，再做决定。', by:'教育顾问 · 示范'},
 {s:'幼升小', q:'公立和私立幼儿园，幼升小衔接有差别吗？', a:'小学零起点教学下，差别主要在习惯而非知识。重点是作息规律、能坐住 20 分钟、表达清楚需求；这些在家也能练。选择时更该看距离与接送可行性。', by:'教育顾问 · 示范'},
 {s:'小升初', q:'奥数还值得学吗？', a:'如果目标是经批准的少数理科特色活动，系统奥数是基础；但对大多数孩子，把校内数学吃透 + 培养阅读理解更划算。学奥数前先问孩子愿不愿意，再问为什么学。', by:'教育顾问 · 示范'},
 {s:'家长心理', q:'家里老人育儿观念不一致，怎么破？', a:'开家庭会议定「底线清单」：写明 3–5 条不可妥协项（如作息、屏幕时间），其余放手。父母是教育决策人，祖辈是执行伙伴——角色先分清，矛盾少一半。', by:'教育顾问 · 示范'}
];
var LEARN_TIPS = [
 ...
 {s:'小升初', q:'对口材料核对，我们家提前一年就开始了', a:'把户籍、房产、居住证明按区教委清单逐项核对，缺什么补什么；每年细则有微调，我们的习惯是「发布当天必读原文」。提前一年准备，临门不慌。', by:'2026 届家长 · 示范'},
 {s:'初升高', q:'体育中考：我们从初一就开始「攒分」', a:'平时体育课和过程性评价的分数，靠突击拿不到。我们从初一就固定每周三次户外运动，既是锻炼也是给大脑放空；到最后统一测试反而是最不用担心的一项。', by:'2025 届家长 · 示范'},
 {s:'陪读生活', q:'全家搬到学校隔壁，我们后悔了吗？', a:'换房半年后复盘：通勤省下 1.5 小时/天是真，但离开了熟悉的玩伴圈也是真。建议先试住再卖房；孩子的社交连续性值得单独评估。', by:'2024 届家长 · 示范'},
 {s:'家长心理', q:'我把「别人家孩子」从家里请出去了', a:'有次脱口而出「你看人家谁谁」，孩子回了一句「那你怎么不看看别人家爸妈」。从那天起我们家只做纵向比较——和他自己上个月比。', by:'2025 届家长 · 示范'}
];
var learnFilter = 'all';
